...
import readandsort.service.StackSorter;
 ...
 * This {@code SorterFactory} was added a {@code StackSorter} to create a
 * stack-based sorter.
 * </p>
 * @author Huihua Huang
 * @version 1.1.0
...
public class SorterFactory {
    ...
    public static CollectionSorter createSorter(String sorterType) {
        ...
        /*
        Reusability:
        ## Changed was made for project 5:
        Add else if (sorterType.equalsIgnoreCase("stack")) {
            return new StackSorter();
        } to the condition.
         */
