 ...
 * ({@code LinkedListSorter}(existing), {@code StackSorter}(future),
...
public class ReadAndSortApp {
    ...
    class, and future StackSorter and ArrayListSorter - all of those reuse the
    ...
    public void run(CollectionSorter sorter, StringToListParser converter) {
        ...
        - Step 2: Choose a sorter to execute sorting logic.
            ...
            - StackSorter(future implementation): Stack is special since the
            smallest is the top of stack on the right.
    ...
    private void printResult() {
        ...
        2) StackSorter(future implementation): (smallest on the right)
        [Success]: The read-and-sort process is successfully made.
        Original Input: 5 0 9 0
