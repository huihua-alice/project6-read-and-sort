...
public class DemoApp {
    ...
    public static void main(String[] args) {
        ...
        String prompt = """
                ...
                Your input:\s""";
        /*
        Maintenance Plan for Project 5:
        Modify the wording for Stack
        Sorting Order: Smallest element on top (right side)
         */
        ...
        // Enter a sorter type such as LinkedList, Stack, ArrayList ...
         String sorterType = "LinkedList";
        /*
        Maintenance Plan for Project 5:
        Modify the sorter type to "Stack"
